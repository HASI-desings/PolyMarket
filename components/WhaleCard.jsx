          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-base-400 mt-0.5">
                Outcome:{" "}
                <span className="text-mint-400 font-medium">{trade.outcome}</span>
              </p>
            </div>
          </div>
        ...
        <div className="flex items-center gap-1.5 mt-3 flex-wrap">
          {trade.whales.slice(0, 8).map((w) => (
            <span
              ...
              className="text-[10px] font-mono bg-base-800 border border-base-700 text-base-400 px-2 py-0.5 rounded-full"
            >
